...
--------- | -----------
LevelInit | Triggered whenever a map is loaded
...
OvertimeShow |
HudSnapShotReminderIn | Reminds the player how to screenshot when viewing the death freeze panel
HudReplayTipIn | Reminds the player how to save a replay when viewing the death freeze panel
HudReplayTipOut | Hides replay reminder when freeze panel ends
HudTournamentSetupPanelOpen | Opens the team name and ready status in mp_tournament 1
HudTournamentSetupPanelClose | Closes the team name and ready status in mp_tournament 1
